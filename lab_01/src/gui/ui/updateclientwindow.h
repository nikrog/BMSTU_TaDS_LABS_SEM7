#ifndef UPDATECLIENTWINDOW_H
#define UPDATECLIENTWINDOW_H
...
class UpdateClientWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit UpdateClientWindow(GUIAuthManager &authmanager, GUIClientManager &clientmanager, GUIManagersManager &managersmanager,
                                GUIProductManager &productmanager, GUIBankManager &bankmanager, GUIRequestManager &requestmanager,
                                ILogger &logger, int cl_id, QWidget *parent = nullptr);
    ~UpdateClientWindow();
