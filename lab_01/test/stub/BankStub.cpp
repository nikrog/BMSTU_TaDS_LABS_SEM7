...
Bank BankStub::getBankByID(int id)
{
...
Bank BankStub::getBankByName(std::string name)
{
    for (Bank tmpBank : this->banks)
    {
...
std::vector<Bank> BankStub::getAllBanks()
{
    return this->banks;
}
int BankStub::addBank(BankInfo inf)
{
...
void BankStub::updateEl(Bank bank_el)
{
    for (Bank tmpBank : this->banks)
    {
